...
const defaultSection: QuizSection = {
      ...
      <div className="flex justify-between items-center">
        <div className="flex-1 space-y-4">
          <input
            ...
            className="w-full px-4 py-2 border border-gray-300 roun shadow-sm focus:ring-blue-500 focus:border-blue-500ded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
          />
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="flex items-center mb-2">
                ...
                >
                  Enable Section Timer
                </label>
              </div>
              
              <div className={section.timerEnabled ? "" : "opacity-50 pointer-events-none"}>
